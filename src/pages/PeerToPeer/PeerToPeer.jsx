  ...
  return (
    <div className='w-full container py-5 h-[100vh]'>
      ...
      <div className="flex flex-col justify-center pt-2 text-center">
        <AiOutlineLock size={100} className='self-center text-purleCommon' />
        <p className='text-purple-500 text-lg'>Peer to peer feature was locked</p>
        <button class="bg-purleCommon hover:bg-blue-700 text-white font-semibold py-1 px-2 rounded w-[15%] text-base" style={{margin: '0 auto'}}>
          Submit your form for confirmation
        </button>
      </div>
    </div>
  )
